...
import cn.qf.b2c.gciantispider.dao.IDataCollectDao;
import cn.qf.b2c.gciantispider.dao.INhCrawlerCurdayInfoDao;
import cn.qf.b2c.gciantispider.dao.IRealTimeComputDataDao;
import cn.qf.b2c.gciantispider.exception.ServiceException;
import cn.qf.b2c.gciantispider.model.Datacollect;
import cn.qf.b2c.gciantispider.model.NhCrawlerCurdayInfo;
import cn.qf.b2c.gciantispider.model.NhLinkTrafficInformation;
import cn.qf.b2c.gciantispider.model.RealTimeComputData;
import cn.qf.b2c.gciantispider.pageUtil.JsonVO;
import cn.qf.b2c.gciantispider.service.IRealTimeComputDataService;
import cn.qf.b2c.gciantispider.util.Constants;
import cn.qf.b2c.gciantispider.util.JedisConnectionUtil;
import cn.qf.b2c.gciantispider.util.TimeUtil;
import cn.qf.b2c.gciantispider.util.TrafficUtil;
...
public class IRealTimeComputDataServiceImpl implements
	...
	public void saveRealTimeComputData() {
		...
		String timeS = TimeUtil.getTimeByMinute(
				TimeUtil.yyyy_MM_DDHH24miss(timeE), -1);
